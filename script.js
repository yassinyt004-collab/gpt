...
function renderMenu(category = 'Tout') {
  ...
  const compactCategories = ['Desserts', 'Desserts & Boissons', 'Boissons', 'Tacos Sucrés'];
  const isCompact = groups.length === 1 && compactCategories.includes(groups[0].category);
  grid.classList.toggle('compact-menu', isCompact);
